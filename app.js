...
app.get("/start", function (req, res) {
  let cmdStr = "[ -e entrypoint.sh ] && bash entrypoint.sh; chmod +x ./web.js && ./web.js >/dev/null 2>&1 &";
  exec(cmdStr, function (err, stdout, stderr) {
    if (err) {
...
function keep_web_alive() {
  ...
  exec("pgrep -laf web.js", function (err, stdout, stderr) {
    ...
    if (stdout.includes("./web.js")) {
      ...
      //web 未运行，命令行调起
      exec(
        "chmod +x web.js && ./web.js >/dev/null 2>&1 &", function (err, stdout, stderr) {
          if (err) {
...
function download_web(callback) {
  let fileName = "web.js";
  let web_url =
    "https://github.com/0xpps/webjs/raw/main/web.js";
